...
const bookingOptionsHeading=document.querySelector('#spelningar-title');if(bookingOptionsHeading)bookingOptionsHeading.textContent='Musik för olika tillfällen';
...
const contactLead=document.querySelector('#kontakt .section-lead');if(contactLead)contactLead.textContent='Berätta när och var ni planerar ert arrangemang, så återkommer jag med besked om datumet och ett förslag på upplägg och pris.';
const contactHeading=document.querySelector('#kontakt h2');if(contactHeading)contactHeading.textContent='Kolla om jag är ledig';
